...
public class Help extends ListenerAdapter {
    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent event) {
        ...
        if (args[0].equalsIgnoreCase(GuildData.getPrefix(event.getGuild()) + "help")) {
            ...
            if (Checks.isBlacklisted(event)) {
                ...
                owner.addField(GuildData.getPrefix(event.getGuild()) + "announce <announcement>", "Will send a message to the owner of every server Quiver is in.", false);
                owner.addField(GuildData.getPrefix(event.getGuild()) + "blacklist <user>", "Will blacklist a user from using Quiver", false);
                owner.addField(GuildData.getPrefix(event.getGuild()) + "botinfo", "Will display all information on the bot. \nOptionally use: `--dm` to send in DM.", false);
                owner.addField(GuildData.getPrefix(event.getGuild()) + "help", "Will show this embed. \nOptionally use: `--dm` to send in DM.", false);
                owner.addField(GuildData.getPrefix(event.getGuild()) + "serverinfo", "Will send an embed with information about the server the command is used in. \nOptionally use: `--dm` to send in DM", false);
                owner.addField(GuildData.getPrefix(event.getGuild()) + "userinfo", "Will send an embed with information about the user that ran the command \nOptionally use: `--dm` to send in DM", false);
                ...
                regular.addField(GuildData.getPrefix(event.getGuild()) + "botinfo", "Will display information on the bot. \nOptionally use: `--dm` to send in DM", false);
                regular.addField(GuildData.getPrefix(event.getGuild()) + "help" , "Will display this. \nOptionally use `--dm` to send in DM", false);
                regular.addField(GuildData.getPrefix(event.getGuild()) + "serverinfo", "Will display information on the server the command is used in.", false);
                regular.addField(GuildData.getPrefix(event.getGuild()) + "userinfo", "Will display information about the user that ran the command \nOptionally tag a member of the server to get information on them", false);
