...
public class SetPrefix extends ListenerAdapter {
    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent event) {
        ...
        if (args[0].equalsIgnoreCase(Utils.getPrefix(event.getGuild()) + "setprefix")) {
            if (args.length < 2) {
                ...
                nullArgs.setFooter("Quiver Custom Prefix Error", Utils.getSelfAvatar(event));
                ...
                try {
                    ...
                    prefix.setFooter("Quiver Custom Prefix", Utils.getSelfAvatar(event));
