        ...
        if(args[0].equalsIgnoreCase(Utils.getPrefix(event.getGuild()) + "unban")){
            if(event.getMember().hasPermission(Permission.BAN_MEMBERS)) {
                if(args.length < 2){
                    ...
                    nullUser.setFooter("Quiver Undefined User", Utils.getSelfAvatar(event));
                    ...
                    banNoReason.setFooter("Quiver Unban Report", Utils.getSelfAvatar(event));
                    ...
                    banWithReason.setFooter("Quiver Unban Report", Utils.getSelfAvatar(event));
