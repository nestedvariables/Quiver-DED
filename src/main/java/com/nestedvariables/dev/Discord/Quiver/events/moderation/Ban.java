...
public class Ban extends ListenerAdapter {
    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent event) {
        ...
        error.setFooter("Quiver System Error", Utils.getSelfAvatar(event));

        if (args[0].equalsIgnoreCase(Utils.getPrefix(event.getGuild()) + "ban")) {
            ...
            if (event.getMember().hasPermission(Permission.BAN_MEMBERS)) {
                if (args.length < 2) {
                    ...
                    try {
                        ...
                        banNoReason.setFooter("Quiver Ban Report", Utils.getSelfAvatar(event));
                    ...
                    try {
                        ...
                        banWithReason.setFooter("Quiver Ban Report", Utils.getSelfAvatar(event));
